...
var band_one = @json($data_one);
// Draw the chart and set the chart values
function drawChart() {
    console.log(band_one[0]);
    console.log(band_one[1]);
  var band_data = google.visualization.arrayToDataTable([
  ['Task', 'Hours per Day'],
  ['Correct Description', band_one[0]],
  ['Wrong Description', band_one[1]],
  
]);

  // Optional; add a title and set the width and height of the chart
  var options = {'title':'Percentage of charts reviewed where child received correct amount of RUTF for [band 1]'};

  // Display the chart inside the <div> element with id="piechart"
  var chart = new google.visualization.PieChart(document.getElementById('piechart-usable'));
  chart.draw(band_data, options);
}
</script>
...
var band_two = @json($data_two);
// Draw the chart and set the chart values
function drawChart() {
    console.log(band_two[0]);
    console.log(band_two[1]);
  var data = google.visualization.arrayToDataTable([
  ['Task', 'Hours per Day'],
  ['correct Description', band_two[0]],
  ['Wrong Description', band_two[1]],
  
]);

  // Optional; add a title and set the width and height of the chart
  var options = {'title':'Percentage of charts reviewed where child received correct amount of RUTF for [band ]'};
...
var sold = @json($sold_data);
// Draw the chart and set the chart values
function drawChart() {
    console.log(sold[0]);
    console.log(sold[1]);
  var sold_data = google.visualization.arrayToDataTable([
  ['Task', 'Hours per Day'],
  ['sold in market ', sold[0]],
  ['Not sold in the market', sold[1]],
  
]);

  // Optional; add a title and set the width and height of the chart
  var options = {'title':'Percentage of facilities where staff report RUTF is being sold on the market'};

  // Display the chart inside the <div> element with id="piechart"
  var chart = new google.visualization.PieChart(document.getElementById('piechart-sold'));
  chart.draw(sold_data, options);
}
</script>
