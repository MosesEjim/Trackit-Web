...
<head>
    ...
    <link rel="stylesheet" href="{{ secure_asset('vendors/datatables.net-bs4/css/dataTables.bootstrap4.min.css')}}">
    <link rel="stylesheet" href="{{ secure_asset('vendors/datatables.net-buttons-bs4/css/buttons.bootstrap4.min.css')}}">
...
<body>
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    @foreach($fs_responses as $response)
                                        <tr>
                                            ...
                                            <td><a type="button" class="btn btn-primary" href = "FSQuestioniares/{{$response->id}}">View Details</a></td>
                                        </tr>
    ...
    <script src="{{ secure_asset('vendors/popper.js/dist/umd/popper.min.js')}}"></script>
    ...
    <script src="{{ secure_asset('vendors/datatables.net-bs4/js/dataTables.bootstrap4.min.js')}}"></script>
    <script src="{{ secure_asset('vendors/datatables.net-buttons/js/dataTables.buttons.min.js')}}"></script>
    <script src="{{ secure_asset('vendors/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js')}}"></script>
    ...
    <script src="{{ secure_asset('vendors/datatables.net-buttons/js/buttons.colVis.min.js')}}"></script>
    <script src="{{ secure_asset('assets/js/init-scripts/data-table/datatables-init.js')}}"></script>
