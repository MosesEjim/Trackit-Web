...
class CreateEductionAvailabilitiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eduction_availabilities', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('eduction_availabilities');
    }
}
